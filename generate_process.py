#this file look for new folders inside user uploads and convert them into reel if they are not already converted
import os
    ...
    while True:
        ...
        for folder in folders:
            if(folder not in done_folders):
                ...
                create_reel(folder)#convert images and audio.mp3 inside the folder to a reel
